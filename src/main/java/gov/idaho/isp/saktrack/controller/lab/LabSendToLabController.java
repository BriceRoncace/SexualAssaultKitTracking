...
@Controller
@LoadEventDetails
public class LabSendToLabController extends BaseController {
  ...
  @RequestMapping(value = "/lab/batchSendToLab", method = RequestMethod.POST)
  public String batchSendToLab(LabUser labUser, @Validated(Batch.class) EventDetails details, BindingResult bindingResult, RedirectAttributes ra) {
    ...
    try {
      labUser.batchSendToLab(details);
