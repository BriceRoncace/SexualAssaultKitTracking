...
@Controller
@LoadEventDetails
public class LabSendToMedicalController extends BaseController {
  ...
  @RequestMapping(value = "/lab/batchSendToMedical", method = RequestMethod.POST)
  public String batchSendToMedical(LabUser labUser, @Validated(Batch.class) EventDetails details, BindingResult bindingResult, RedirectAttributes ra) {
