...
@Controller
@LoadEventDetails
public class LawEnforcementSendToLawEnforcementController extends BaseController {
  ...
  @RequestMapping(value = "/law-enforcement/sendToLawEnforcement", method = RequestMethod.POST)
  public String send(LawEnforcementUser lawUser, @Validated(Single.class) EventDetails details, BindingResult bindingResult, RedirectAttributes ra) {
