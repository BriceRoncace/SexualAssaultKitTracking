...
public interface SexualAssaultKitRepository extends CustomSexualAssaultKitRepository, JpaRepository<SexualAssaultKit,Long>, JpaSpecificationExecutor<SexualAssaultKit> {
