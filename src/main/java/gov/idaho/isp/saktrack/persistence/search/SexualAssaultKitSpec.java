...
import gov.idaho.isp.saktrack.ChainOfCustodyEvent_;
import gov.idaho.isp.saktrack.EventFlag;
import gov.idaho.isp.saktrack.LabDetails;
import gov.idaho.isp.saktrack.LabDetails_;
import gov.idaho.isp.saktrack.LawEnforcementDetails;
import gov.idaho.isp.saktrack.LawEnforcementDetails_;
import gov.idaho.isp.saktrack.LegalDetails;
import gov.idaho.isp.saktrack.LegalDetails_;
import gov.idaho.isp.saktrack.MedicalDetails;
import gov.idaho.isp.saktrack.MedicalDetails_;
import gov.idaho.isp.saktrack.SexualAssaultKit;
import gov.idaho.isp.saktrack.SexualAssaultKit_;
import gov.idaho.isp.saktrack.jurisdiction.Jurisdiction;
import gov.idaho.isp.saktrack.jurisdiction.Jurisdiction_;
import gov.idaho.isp.saktrack.organization.Organization;
import gov.idaho.isp.saktrack.organization.Organization_;
