    ...
    <form class="bottom30" action="<c:url value='/admin/saveDetails'/>" method="POST">
      ...
      <div class="row top15">
        <div class="form-group col-sm-3">
          ...
          <input type="text" class="form-control hasDatePicker" name="expirationDate" value="<cjisTags:fmtTemporal value="${kit.expirationDate}" pattern="${dateFormat}" />"/>
        </div>
      </div>
      ...
      <div class="row">
        <div class="form-group col-sm-12">
          ...
          <cjisTags:select from="${nonSubmissionReasons}" name="legalDetails.nonSubmissionReason" optionValue="label" value="${kit.legalDetails.nonSubmissionReason}" emptyOption="" cssClass="form-control"/>
        </div>
      </div>
      <div class="row">
        <div class="col-sm-3">
      ...
      <div class="row">
        <div class="col-sm-3">
          <div class="form-group">
            ...
            <input type="text" class="form-control hasDatePicker" name="legalDetails.releasedForReview" value="<cjisTags:fmtTemporal value='${kit.legalDetails.releasedForReview}' pattern='${dateFormat}' />"/>
          </div>
        </div>
        <div class="col-sm-3">
          <div class="form-group">
            <label>Review Finalized On</label>
            <input type="text" class="form-control hasDatePicker" name="legalDetails.reviewFinalized" value="<cjisTags:fmtTemporal value='${kit.legalDetails.reviewFinalized}' pattern='${dateFormat}' />"/>
          </div>
        </div>
      </div>
      <div class="row top15">
