    ...
    <form id="search-form" data-toggleable class="${searchRun ? 'hidden' : ''}" method="get">
      ...
      <div class="row grey-background">
        <div class="col-xs-2">
          <div class="form-group">
            ...
            <cjisTags:select name="eventType" from="${eventTypes}" emptyOption="" cssClass="form-control" optionValue="label" value="${criteria.eventType}"/>
          </div>
        </div>
        <div class="col-xs-3">
          <div class="form-group">
        ...
        <div class="col-xs-3">
          <div class="form-group">
            ...
            <cjisTags:select name="eventOrganization" from="${organizations}" emptyOption="" cssClass="form-control" optionKey="id" optionValue="name" value="${criteria.eventOrganization}"/>
          </div>
        </div>
        <div class="col-xs-4">
          <div class="form-group">
            ...
            <div class="input-group">
              <input type="text" class="form-control hasDatePicker" name="eventDate.date1" value="<cjisTags:fmtTemporal value="${criteria.eventDate.date1}" pattern="${dateFormat}"/>">
              <span class="input-group-addon invisible">-</span>
              <input type="text" class="form-control hasDatePicker invisible" name="eventDate.date2" value="<cjisTags:fmtTemporal value="${criteria.eventDate.date2}" pattern="${dateFormat}"/>">
            </div>
          </div>
        </div>  
      </div>
      ...
      <div class="row">
        <div class="col-xs-2">
          <div class="form-group">
            ...
            <cjisTags:select name="victimType" from="${victimTypes}" emptyOption="" cssClass="form-control" optionValue="label" value="${criteria.victimType}"/>
          </div>
        </div>
        <div class="col-xs-4">
          <div class="form-group">
        ...
        <div class="form-group col-sm-2">
          ...
          <select class="form-control" name="jurisdictionId">
            <option></option>
            <c:forEach var="jurisdiction" items="${jurisdictions}">
              <option value="${jurisdiction.id}" <c:if test="${jurisdiction.id == criteria.jurisdictionId}">selected</c:if>>${jurisdiction.displayName}</option>
            </c:forEach>
          </select>
        </div>
      </div>
      ...
      <div class="row grey-background">
        ...
        <div class="col-xs-4">
          <div class="form-group">
            ...
            <div class="input-group">
              <input type="text" class="form-control hasDatePicker" name="crimeDate.date1" value="<cjisTags:fmtTemporal value="${criteria.crimeDate.date1}" pattern="${dateFormat}"/>">
              <span class="input-group-addon invisible">-</span>
              <input type="text" class="form-control hasDatePicker invisible" name="crimeDate.date2" value="<cjisTags:fmtTemporal value="${criteria.crimeDate.date2}" pattern="${dateFormat}"/>">
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="row grey-background">
        ...
        <div class="form-group col-xs-3">
          ...
          <cjisTags:select from="${nonSubmissionReasons}" name="nonSubmissionReason" optionValue="label" value="${criteria.nonSubmissionReason}" emptyOption="" cssClass="form-control"/>
        </div>
        ...
        <div class="col-xs-4">
          <div class="form-group">
            ...
            <div class="input-group">
              <input type="text" class="form-control hasDatePicker" name="plannedDestructionDate.date1" value="<cjisTags:fmtTemporal value="${criteria.plannedDestructionDate.date1}" pattern="${dateFormat}"/>">
              <span class="input-group-addon invisible">-</span>
              <input type="text" class="form-control hasDatePicker invisible" name="plannedDestructionDate.date2" value="<cjisTags:fmtTemporal value="${criteria.plannedDestructionDate.date2}" pattern="${dateFormat}"/>">
            </div>
          </div>
        </div>       
      </div>      
      ...
      <div class="row">
        ...
        <div class="col-xs-4">
          <div class="form-group">
            ...
            <div class="input-group">
              <input type="text" class="form-control hasDatePicker" name="completedDate.date1" value="<cjisTags:fmtTemporal value="${criteria.completedDate.date1}" pattern="${dateFormat}"/>">
              <span class="input-group-addon invisible">-</span>
              <input type="text" class="form-control hasDatePicker invisible" name="completedDate.date2" value="<cjisTags:fmtTemporal value="${criteria.completedDate.date2}" pattern="${dateFormat}"/>">
            </div>
          </div>
        </div>
      </div>           
      ...
      <div class="row">
        ...
        <div class="col-xs-4">
          <div class="form-group">
            ...
            <div class="input-group">
              <input type="text" class="form-control hasDatePicker" name="dnaDatabaseHitDate.date1" value="<cjisTags:fmtTemporal value="${criteria.dnaDatabaseHitDate.date1}" pattern="${dateFormat}"/>">
              <span class="input-group-addon invisible">-</span>
              <input type="text" class="form-control hasDatePicker invisible" name="dnaDatabaseHitDate.date2" value="<cjisTags:fmtTemporal value="${criteria.dnaDatabaseHitDate.date2}" pattern="${dateFormat}"/>">
            </div>
          </div>
        </div>
        <div class="col-xs-4">
          <div class="form-group">
            ...
            <div class="input-group">
              <input type="text" class="form-control hasDatePicker" name="expungedDate.date1" value="<cjisTags:fmtTemporal value="${criteria.expungedDate.date1}" pattern="${dateFormat}"/>">
              <span class="input-group-addon invisible">-</span>
              <input type="text" class="form-control hasDatePicker invisible" name="expungedDate.date2" value="<cjisTags:fmtTemporal value="${criteria.expungedDate.date2}" pattern="${dateFormat}"/>">
            </div>
          </div>
        </div>
      </div>      
