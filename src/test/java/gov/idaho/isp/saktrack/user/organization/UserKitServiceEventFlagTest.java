...
public class UserKitServiceEventFlagTest {
  ...
  public void testSetup() {
    ...
    when(orgRepo.findOne(labOrg.getId())).thenReturn(labOrg);
    when(orgRepo.findOne(medOrg.getId())).thenReturn(medOrg);
    when(orgRepo.findOne(lawOrg.getId())).thenReturn(lawOrg);
